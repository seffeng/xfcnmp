...
println "********************************************************************************\n" yellow;
shl_cmd="yum -y install gcc gcc-c++ make";
...
shl_exec "if [ ! -f /usr/bin/automake-1.14 ] ; then (ln -s /usr/bin/automake /usr/bin/automake-1.14) fi";
shl_exec "if [ ! -f /usr/bin/aclocal-1.15 ] ; then (ln -s /usr/bin/aclocal /usr/bin/aclocal-1.15) fi";
shl_exec "if [ ! -f /usr/bin/aclocal-1.14 ] ; then (ln -s /usr/bin/aclocal /usr/bin/aclocal-1.14) fi";
...
println "if [ ! -f /usr/bin/automake-1.14 ] ; then (ln -s /usr/bin/automake /usr/bin/automake-1.14) fi" purple;
println "if [ ! -f /usr/bin/aclocal-1.15 ] ; then (ln -s /usr/bin/aclocal /usr/bin/aclocal-1.15) fi" purple;
println "if [ ! -f /usr/bin/aclocal-1.14 ] ; then (ln -s /usr/bin/aclocal /usr/bin/aclocal-1.14) fi" purple;
